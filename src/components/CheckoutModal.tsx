...
export default function CheckoutModal({ isOpen, onClose, planId, planName, price, originalPrice }: Props) {
    ...
    // Sincronizar o preço inicial sempre que o modal abre ou o plano muda
    useEffect(() => {
                    ...
                    >
                        ...
                        <p className="text-slate-400 mb-8">
                            {step === "info"
                                ? (
                                    <>
                                        Você está adquirindo o <span className="text-cyan-400 font-bold">{planName}</span> 
                                        {originalPrice && <span className="text-xs line-through ml-2 text-slate-500">De R$ {originalPrice}</span>}
                                        <span className="text-white font-black text-lg block mt-1">Por R$ {finalPrice}</span>
                                    </>
                                )
